...
const Index = () => {
  ...
  const products = {
    phones: [
      { id: 1, name: "iPhone 15 Pro", price: 999, image: "/placeholder.svg", rating: 4.8, category: "phones" },
      { id: 2, name: "Samsung Galaxy S24", price: 899, image: "/placeholder.svg", rating: 4.7, category: "phones" },
      { id: 3, name: "Google Pixel 8", price: 699, image: "/placeholder.svg", rating: 4.6, category: "phones" },
      { id: 4, name: "OnePlus 12", price: 799, image: "/placeholder.svg", rating: 4.5, category: "phones" },
    ],
    laptops: [
      { id: 5, name: "MacBook Pro M3", price: 1999, image: "/placeholder.svg", rating: 4.9, category: "laptops" },
      { id: 6, name: "Dell XPS 13", price: 1299, image: "/placeholder.svg", rating: 4.6, category: "laptops" },
      { id: 7, name: "ThinkPad X1 Carbon", price: 1599, image: "/placeholder.svg", rating: 4.7, category: "laptops" },
      { id: 8, name: "Surface Laptop 5", price: 1199, image: "/placeholder.svg", rating: 4.5, category: "laptops" },
    ],
    smartwatches: [
      { id: 9, name: "Apple Watch Series 9", price: 399, image: "/placeholder.svg", rating: 4.8, category: "smartwatches" },
      { id: 10, name: "Samsung Galaxy Watch 6", price: 329, image: "/placeholder.svg", rating: 4.6, category: "smartwatches" },
      { id: 11, name: "Garmin Forerunner 955", price: 499, image: "/placeholder.svg", rating: 4.7, category: "smartwatches" },
      { id: 12, name: "Fitbit Versa 4", price: 199, image: "/placeholder.svg", rating: 4.4, category: "smartwatches" },
    ],
    gaming: [
      { id: 13, name: "PS5 Console", price: 499, image: "/placeholder.svg", rating: 4.9, category: "gaming" },
      { id: 14, name: "Xbox Series X", price: 499, image: "/placeholder.svg", rating: 4.8, category: "gaming" },
      { id: 15, name: "Nintendo Switch OLED", price: 349, image: "/placeholder.svg", rating: 4.7, category: "gaming" },
      { id: 16, name: "Steam Deck", price: 399, image: "/placeholder.svg", rating: 4.6, category: "gaming" },
    ],
    audio: [
      { id: 17, name: "AirPods Pro 2", price: 249, image: "/placeholder.svg", rating: 4.8, category: "audio" },
      { id: 18, name: "Sony WH-1000XM5", price: 399, image: "/placeholder.svg", rating: 4.7, category: "audio" },
      { id: 19, name: "Bose QuietComfort", price: 329, image: "/placeholder.svg", rating: 4.6, category: "audio" },
      { id: 20, name: "JBL Flip 6", price: 129, image: "/placeholder.svg", rating: 4.5, category: "audio" },
    ],
    accessories: [
      { id: 21, name: "MagSafe Charger", price: 39, image: "/placeholder.svg", rating: 4.5, category: "accessories" },
      { id: 22, name: "Anker PowerBank", price: 49, image: "/placeholder.svg", rating: 4.6, category: "accessories" },
      { id: 23, name: "Logitech MX Master 3", price: 99, image: "/placeholder.svg", rating: 4.7, category: "accessories" },
      { id: 24, name: "USB-C Hub", price: 79, image: "/placeholder.svg", rating: 4.4, category: "accessories" },
    ],
  };
